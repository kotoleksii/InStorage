...
{{--            <div class="col-md-8">--}}
                <form method="get" action="">
                    ...
                    <div class="d-grid gap-2 d-md-block mt-2">
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-warning btn-lg me-md-4 col-2" data-bs-toggle="modal" data-bs-target="#">
                            Edit
                        </button>

                        <button type="button" class="btn btn-danger btn-lg me-md-4 col-2" data-bs-toggle="modal" data-bs-target="#">
                            Delete
                        </button>

                        <button type="button" class="btn btn-info btn-lg me-md-4 col-2" data-bs-toggle="modal" data-bs-target="#">
                            Forward
                        </button>
                    </div>
...
{{--                            <td>{{$material->score_id}}</td>--}}
                            ...
                            <a class="btn btn-warning btn-sm" data-bs-toggle="modal" href="materials/edit/{{$material->id}}" data-bs-target="#exampleModal3">Edit
...
{{--            <div class="col-md-3 mx-auto">--}}
                ...
                <!-- Modal -->
                <div class="modal hide fade" id="exampleModal" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
...
{{--                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>--}}
                    ...
                    <!-- Modal Update -->
                    <div class="modal fade" id="exampleModal3" aria-hidden="true" aria-labelledby="exampleModalLabel3" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content bg-dark">
                                <div class="card shadow modal-body bg-dark rounded">
