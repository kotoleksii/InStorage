...
{{--                        <span class="fs-5 pt-3">I<span class="pt-3 d-none d-sm-inline" style="color:#f39c12 !important">InStorage</span></span>--}}
                        <span class="fs-5 pt-3"><img src="{{asset('images/logo.png')}}" alt="logo" width="35" height="35"><span class="pt-3 d-none d-sm-inline" style="color:#f57961">InStorage</span></span>
                    </a>
    ...
    {{--                </div>--}}
            ...
            <!-- Start Content Block -->
            <div class="col d-flex flex-column h-sm-100 vh-100">
                <main class="row">
                    <div class="col col-md-11 ms-2 pt-4">
                        @yield('main_content')
                    </div>
                </main>
            </div>
